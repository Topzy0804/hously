...
const SignIn: React.FC = () => {
  ...
  return (
    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div
        className="absolute inset-0 z-0 bg-[url('/login-house.jpg')] bg-cover bg-center animate-[ken-burns_20s_ease-in-out_infinite_alternate] transform-gpu"
      />
      ...
      <div className="relative z-20 w-full max-w-md mx-4 bg-white/95 backdrop-blur-sm shadow-2xl flex flex-col items-center gap-8 py-10 px-8 rounded-xl border border-gray-200">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-800 font-montserrat">Sign In</h1>
        </div>
        ...
        <div className="w-full font-inter">
          ...
          <p className="text-center mt-6 text-sm text-gray-600">
            Don't have an account? <Link href="/auth/sign-up" className="text-black font-bold hover:underline">Sign up</Link>
          </p>
        </div>
      </div>
    </section>
